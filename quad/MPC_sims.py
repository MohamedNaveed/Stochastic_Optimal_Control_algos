...
HPRC = False
Model = 'quad' #'car_model' #'youBot_model'
...
if FILE_WRITE:
    filename = "/home/naveed/Dropbox/Research/Data/WAFR20/Quad/MPC_1_wo_obs_modified1.csv"
...
def MPC_run_varying_epsilon():
    ...
    epsi_range = np.linspace(0.01,.20,20)
...
def MPC(U_opti_ini,T,X0,epsilon):
    ...
    while iter < no_iters:
        ...
        enablePrint()
        print "iter:",iter, " Cost_Cl:", Cost_CL
        blockPrint()
